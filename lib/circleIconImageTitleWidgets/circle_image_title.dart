...
class CircleImageTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final imageToDisplay =
        image ?? defaultImage; // Use default if image is null

    return Stack(
      // Use a Stack to position the cancel button
      children: [
        InkWell(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: imageToDisplay != null
                          ? Stack(
                            // Use a Stack to overlay the gray avatar
                            alignment: Alignment.center,
                            children: [
                              CircleAvatar(
                                // The original image avatar
                          ...
                          : Icon(
                            ...
                            color:
                                Colors
                                    .grey[600], // Slightly darker grey for placeholder
                          ),
                ),
              ),
              SizedBox(
